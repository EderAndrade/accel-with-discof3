...
const static st_gpio_pin_t IO[NUM_OF_IOS] = 
{
    ...
    {RED_LED_GPIO_Port	    , RED_LED_Pin       }, // Red Noth   
    {ORANGE_LED_GPIO_Port	, ORANGE_LED_Pin    },    
    {GREEN_LED_GPIO_Port	, GREEN_LED_Pin     }, // Green East   
    {BLUE_LEDE12_GPIO_Port	, BLUE_LEDE12_Pin   },    
    {RED_LEDE13_GPIO_Port	, RED_LEDE13_Pin    }, // Red south
    {ORANGE_LEDE14_GPIO_Port, ORANGE_LEDE14_Pin },
    {GREEN_LEDE15_GPIO_Port	, GREEN_LEDE15_Pin  }, // Green West
};
...
st_gpio_t GPIO = 
{
    ...
    .State[eLedBlue1] 		= GPIO_PIN_RESET,   
    .State[eLedRed1] 		= GPIO_PIN_RESET, 
    .State[eLedOrange1] 	= GPIO_PIN_RESET, 
    .State[eLedGreen1] 		= GPIO_PIN_RESET, 
    .State[eLedBlue2] 		= GPIO_PIN_RESET, 
    .State[eLedRed2] 		= GPIO_PIN_RESET, 
    .State[eLedOrange2] 	= GPIO_PIN_RESET, 
    .State[eLedGreen2] 		= GPIO_PIN_RESET, 
...
static int8_t ea_gpio_open(void)
{
    ...
    HAL_GPIO_WritePin(GPIOE,    BLUE_LED_Pin        |
                                RED_LED_Pin         |
                                ORANGE_LED_Pin      |
                                GREEN_LED_Pin       |
                                BLUE_LEDE12_Pin     |
